...
Before you can host on vercel you need to create an account, and have a NextJS project committed to GitHub. It doesnt need to be NextJS but following the previous blog posts thats what we will cover.
