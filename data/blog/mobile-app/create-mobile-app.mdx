...
### 3.2 Install Java Development Kit (JDK)
...
# 4. Create a New React Native App
...
# 5. Configure Android Project Versions

Open the folder in VS Code or Android Studio.

### 5.1 Edit Gradle settings
...
### 7.1 “Unable to load script from metro server” error
...
### 7.2 Max Path Length on Windows
...
### 7.3 Gradle Dependency Conflicts
